...
class RandomScaleCrop(object):
    ...
    def __call__(self, sample):
        ...
        if h > w:
            ...
            oh = short_size
            ow = int(1.0 * w * oh / h)
        img = img.resize((ow, oh), Image.BILINEAR) # this is default setting, but it shows a weird phenomenon with different crop settings, in need of further evaluations
        #img = img.resize((ow, oh), Image.NEAREST) # try nearest
